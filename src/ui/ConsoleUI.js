...
class ConsoleUI {
    ...
    buscarPetPerdidoPorNome() {
        ...
        this.listarPetsComDetalhes(petsEncontrados, `Pets Perdidos com nome contendo "${nome}"`);
    }
    ...
    buscarPetPerdidoPorLocalidade() {
        ...
        this.listarPetsComDetalhes(petsEncontrados, `Pets Perdidos em localidade contendo "${localidade}"`);
    }
    ...
    processarRegistroPetPerdido() {
        ...
        const dadosPet = {
            ...
            comentarioTutor: readlineSync.question("Alguma observação importante? (ex: usa coleira, tem mancha específica): "),
            foto: readlineSync.question("Link para uma foto (opcional, deixe em branco se não tiver): ") || undefined
        };
    ...
    processarMarcarPetComoEncontrado() {
        ...
        if (petParaMarcar) {
            ...
            console.log("ID inválido ou o pet não pertence a você/não está como perdido.");
        }
        this.pausar();
    }
